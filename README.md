...
![alt-текст](https://github.com/IrinaPr/hw6/blob/master/%D0%A1%D0%BA%D1%80%D0%B8%D0%BD%D1%88%D0%BE%D1%82%202018-04-14%2021_43_40.png)
## Мы видим, что с обоими глаголами (arrive/come) употребляются такие слова, как "evening", "tomorrow", "hour", и другие(выделенные белым цветом). Только со словом "arrive" употребляются слова, выделенные зеленым цветом(immigrant,ambulance и др.) Только со словом "come" употребляются слова, выделенные красным (dream,downstairs и др.) 

### 3. Бонусное задание
![alt-текст](https://github.com/IrinaPr/hw6/blob/master/%D0%A1%D0%BA%D1%80%D0%B8%D0%BD%D1%88%D0%BE%D1%82%202018-04-14%2022_03_22.png)
![alt-текст](https://github.com/IrinaPr/hw6/blob/master/%D0%A1%D0%BA%D1%80%D0%B8%D0%BD%D1%88%D0%BE%D1%82%202018-04-14%2022_06_33.png)
![alt-текст](https://github.com/IrinaPr/hw6/blob/master/%D0%A1%D0%BA%D1%80%D0%B8%D0%BD%D1%88%D0%BE%D1%82%202018-04-14%2022_28_37.png)

## Проведя анализ данных в SketchEngine и GoogleNgramViewer, я обнаружила, что данные различны. В SketchEngine показано, что в 1991г. частотность употребленияслова "peace" наиболее высока, тогда как в GoogleNgramViewer на этот же год приходится не пик употребления.Также в SketchEngine частотность резко возрастает и после 1991 г. постепенно снижается; в GoogleNgramViewer на этот же период приходится не такое заметное увеличение частотности. Разница в показателях может быть связана с тем, что данные, по которым велись расчеты, были взяты из различных исочников информации. 
